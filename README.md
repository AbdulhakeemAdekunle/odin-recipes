...
Your can access the website on [The Website Name](AbdulhakeemAdekunle.github.io/odin-recipes)  
From the HomePage, you'll find a link to other pages where each recipe is being talked about. Also from each recipe's page, there's a link back to the HomePage where you can go back to see the links to other recipes' pages.
